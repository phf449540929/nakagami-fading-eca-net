function depunctured_bits = conv_rx_depuncture(in_bits, code_rate)
    ...
    depunc_bits = reshape(in_bits(1:length(in_bits)-num_rem_bits), length(punc_patt), fix(length(in_bits)/length(punc_patt)));
