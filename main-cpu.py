...
def main():
    ...
    # Data loading code
    # python main.py -a eca_resnet152 --ksize 3557 ./dataset-type-1.0db.csv
    root_dir = args.data
    snr = 1.0
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        prec1, prec5, val_class = validate(val_loader, model, criterion)
...
def validate(val_loader, model, criterion):
    ...
    return top1.avg, top5.avg, val_class
